...
public class feedback extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("AR DELANEY", 0, 36)); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ABC.jpg"))); // NOI18N
    ...
    int rating=Integer.parseInt(t1.getText());
    String fdbk=ta1.getText();
    try{
      Class.forName("java.sql.DriverManager");
            Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/gamin","root","");
            Statement s=(Statement)con.createStatement();
            s.executeUpdate("insert into rating values("+rating+",'"+fdbk+"')");
